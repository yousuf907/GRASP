...
#### This script is MobileNet with Cosine FC layer for Experience Replay (ER) ####
...
#net = torchvision.models.mobilenet_v3_large(pretrained=True, width_mult=1.0,  reduced_tail=False, dilated=False)
...
#net = eval('MobNet_StartAt_Layer5')()
#net=net.cuda()
#inputs = torch.randn((10, 40, 28, 28), dtype=torch.float32)
#inputs = torch.randn((10, 160, 7, 7), dtype=torch.float32)
#outputs = net(inputs.cuda())
#print('Shape of outputs:', outputs.shape)

#for param_tensor in net.state_dict():
#    print(param_tensor, "\t", net.state_dict()[param_tensor].size())
#print(net.state_dict()[param_tensor].dtype)

#total_params = sum(param.numel() for param in net.parameters())
#print("number of trainable params in Million:", (total_params)/1e6)
