...
import torch
import os
import utils_places_pq as utils_places
import utils_pq_LT as utils
from retrieve_any_layer import ModelWrapper
from utils_pq_LT import build_classifier
import functools
...
def extract_base_init_features(places_path, label_dir, extract_features_from, classifier_ckpt, arch,
    ...
    base_train_loader = utils_places.get_places_data_loader(places_path + '/train', label_dir, split='train',
