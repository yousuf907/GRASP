...
def get_places_data_loader(dirname, label_dir, split, batch_size=128, shuffle=False, min_class=0, max_class=None, seed=1,
            sampler=None, batch_sampler=None, dataset_name='places', return_item_ix=False, num_workers=8):
