...
### SIESTA / MobileNet / ImageNet / Latent Rehearsal ###
...
def streaming(args, siesta):
    ...
    if args.resume_full_path is not None:
        ...
        print('\nSIESTA accuracy on BASE-INIT classes: top1=%0.2f%% -- top5=%0.2f%%' % (top1_base, top5_base))
    ...
    for class_ix in range(args.streaming_min_class, args.streaming_max_class, args.class_increment):
        ...
        #/////////////////////////////////////////////// SLEEP PHASE /////////////////////////////////////////////
            ...
            #siesta.rehearsal_uniform_bal(opq, pq, latent_dict, rehearsal_ixs, num_iter)

            print("\nRehearsal Policy is GRASP")
            siesta.rehearsal_grasp(opq, pq, latent_dict, rehearsal_ixs, num_iter)

            #print("\nRehearsal Policy is Easy Only")
            #siesta.rehearsal_grasp_easy(opq, pq, latent_dict, rehearsal_ixs, num_iter)

            #print("\nRehearsal Policy is Hard Only")
            #siesta.rehearsal_grasp_hard(opq, pq, latent_dict, rehearsal_ixs, num_iter)

            #print("\nRehearsal Policy is Uniform")
            #siesta.rehearsal_uniform(opq, pq, latent_dict, rehearsal_ixs, num_iter)

            #print("\nRehearsal Policy is Min Margin")
            #siesta.rehearsal_margin(opq, pq, latent_dict, rehearsal_ixs, num_iter)

            #print("\nRehearsal Policy is Min Confidence")
            #siesta.rehearsal_min_conf(opq, pq, latent_dict, rehearsal_ixs, num_iter)

            #print("\nRehearsal Policy is Min Logit Distance")
            #siesta.rehearsal_min_logit(opq, pq, latent_dict, rehearsal_ixs, num_iter)

            #print("\nRehearsal Policy is Max Loss")
            #siesta.rehearsal_ml(opq, pq, latent_dict, rehearsal_ixs, num_iter)

            #print("\nRehearsal Policy is Min Rehearsal")
            #siesta.rehearsal_minrep(opq, pq, latent_dict, rehearsal_ixs, new_class_list, num_iter)

            #print("\nRehearsal Policy is Max Interference")
            #siesta.rehearsal_mir(opq, pq, latent_dict, rehearsal_ixs, new_class_list, num_iter)

            #print("\nRehearsal Policy is kMeans")
            #siesta.rehearsal_km(opq, pq, latent_dict, rehearsal_ixs, num_iter)
