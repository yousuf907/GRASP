#!/usr/bin/env bash
EXPT_NAME=grasp_veridical_rehearsal_imagenet_1k_exp
IMAGE_DIR=/data/datasets/ImageNet1K # change path to dataset dir
LABEL_ORDER_DIR=./imagenet_files/
BASE_INIT_CKPT=./base_init_ER_mobilenet_swav_cosine_loss_sgd_step_aug_100c_50e_updated.pth
GPU=0
## some arguments are redundant and may not be used! ignore them!
...
NUM_CLASSES=1000
EPOCH=50
BATCH=256 # mini-batch size during rehearsal
BS=256 # data loader 256

CUDA_VISIBLE_DEVICES=${GPU} python -u imagenet_exp_veridical.py \
